...
full_code_path = os.path.join(os.getcwd(), "nlu", "SlotGatedSLU")
...
parser.add_argument("--max_epochs", type=int, default=130, help="Max epochs to train.")
parser.add_argument(
    "--no_early_stop",
    action="store_false",
    dest="early_stop",
...
parser.add_argument(
    "--model_path", type=str, default=os.path.join(os.getcwd(), full_code_path, "model"), help="Path to save model."
)
...
full_train_path = os.path.join(full_code_path, "data", arg.dataset, arg.train_data_path)
full_test_path = os.path.join(full_code_path, "data", arg.dataset, arg.test_data_path)
full_valid_path = os.path.join(full_code_path, "data", arg.dataset, arg.valid_data_path)

createVocabulary(
    os.path.join(full_train_path, arg.input_file),
    os.path.join(full_code_path, arg.vocab_path, "in_vocab"),
)
createVocabulary(
    os.path.join(full_train_path, arg.slot_file),
    os.path.join(full_code_path, arg.vocab_path, "slot_vocab"),
)
createVocabulary(
    os.path.join(full_train_path, arg.intent_file),
    os.path.join(full_code_path, arg.vocab_path, "intent_vocab"),
)

in_vocab = loadVocabulary(os.path.join(full_code_path, arg.vocab_path, "in_vocab"))
slot_vocab = loadVocabulary(os.path.join(full_code_path, arg.vocab_path, "slot_vocab"))
intent_vocab = loadVocabulary(os.path.join(full_code_path, arg.vocab_path, "intent_vocab"))
